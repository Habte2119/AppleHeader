		    ...
		    <div className="container">
		      ...
		      <div className="collapse navbar-collapse" id="navbarResponsive">
		        <ul className="navbar-nav nav-fill w-100">
					...
					<li className="nav-item"><a className="nav-link js-scroll-trigger" href="#">Store</a></li>
					...
					<li className="nav-item"><a className="nav-link js-scroll-trigger" href="#">Tv & Home</a></li>
					<li className="nav-item"><a className="nav-link js-scroll-trigger" href="#">Music</a></li>
					<li className="nav-item"><a className="nav-link js-scroll-trigger" href="#">Entertainmnet</a></li>
					<li className="nav-item"><a className="nav-link js-scroll-trigger" href="#">Acceessories</a></li>
